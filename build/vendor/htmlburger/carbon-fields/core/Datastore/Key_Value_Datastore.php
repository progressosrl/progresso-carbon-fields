 ...
 */
abstract class Key_Value_Datastore extends \Progresso\Carbon_Fields\Datastore\Datastore
{
    /**
    ...
    {
        $this->key_toolset = \Progresso\Carbon_Fields\Carbon_Fields::resolve('key_toolset');
        parent::__construct();
    }
    /**
     ...
     * @return array<string>
     */
    protected function get_full_hierarchy_for_field(\Progresso\Carbon_Fields\Field\Field $field)
    {
     ...
     * @return array<int>
     */
    protected function get_full_hierarchy_index_for_field(\Progresso\Carbon_Fields\Field\Field $field)
    {
    ...
    protected function cascading_storage_array_to_value_tree_array($storage_array)
    {
        ...
        \Progresso\Carbon_Fields\Helper\Helper::ksort_recursive($tree);
     ...
     * @return array
     */
    protected function value_tree_array_to_value_tree($value_tree_array, \Progresso\Carbon_Fields\Field\Field $field)
    {
     ...
     */
    protected abstract function get_storage_array(\Progresso\Carbon_Fields\Field\Field $field, $storage_key_patterns);
    /**
