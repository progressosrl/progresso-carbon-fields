...
class Nav_Menu_Item_Datastore extends \Progresso\Carbon_Fields\Datastore\Post_Meta_Datastore
{
    ...
    {
        $name = \is_object($field) && \is_subclass_of($field, 'Progresso\\Carbon_Fields\\Field\\Field') ? $field->get_name() : $field;
