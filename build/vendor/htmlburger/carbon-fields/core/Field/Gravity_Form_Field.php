 ...
 */
class Gravity_Form_Field extends \Progresso\Carbon_Fields\Field\Select_Field
{
    /**
    ...
    {
        if (\class_exists('Progresso\\RGFormsModel') && \method_exists('\\RGFormsModel', 'get_forms')) {
            return \true;
        }
        return \false;
    }
    ...
    protected function get_gravity_form_options()
    {
        ...
        $forms = \Progresso\RGFormsModel::get_forms(null, 'title');
    ...
    {
        $this->set_options(apply_filters('progresso_carbon_fields_gravity_form_options', $this->get_options()));
