 ...
 */
class Select_Field extends \Progresso\Carbon_Fields\Field\Predefined_Options_Field
{
    /**
     * {@inheritDoc}
     */
    public function set_value_from_input($input)
    {
        ...
        if (isset($input[$this->get_name()])) {
            ...
            $raw_value = \Progresso\Carbon_Fields\Helper\Helper::get_valid_options(array($raw_value), $options_values);
            if (!empty($raw_value)) {
                $value = $raw_value[0];
            }
        }
