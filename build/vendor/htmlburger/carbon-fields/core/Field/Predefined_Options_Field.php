 ...
 */
abstract class Predefined_Options_Field extends \Progresso\Carbon_Fields\Field\Field
{
    /**
    ...
    public function set_options($options)
    {
        if (!\is_callable($options) && !\is_array($options)) {
            \Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('Only arrays and callbacks are allowed in the <code>set_options()</code> method.');
            return $this;
        }
    ...
    {
        if (!\is_callable($options) && !\is_array($options)) {
            \Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('Only arrays and callbacks are allowed in the <code>add_options()</code> method.');
            return $this;
        }
    ...
    protected function get_values_from_options($values)
    {
        ...
        $values = \Progresso\Carbon_Fields\Helper\Helper::get_valid_options($values, $options_values);
        return $values;
    }
}
