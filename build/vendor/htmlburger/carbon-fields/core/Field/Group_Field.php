...
class Group_Field
{
    ...
    public function add_fields($fields)
    {
        foreach ($fields as $field) {
            if (!$field instanceof \Progresso\Carbon_Fields\Field\Field) {
                \Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('Object must be of type ' . __NAMESPACE__ . '\\Field');
            }
    ...
    public function set_name($name)
    {
        ...
        if (!\Progresso\Carbon_Fields\Helper\Helper::is_valid_entity_id($name)) {
            \Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('Group names can only contain lowercase alphanumeric characters, dashes and underscores ("' . $name . '" passed).');
            return $this;
        }
        $this->name = $name;
        return $this;
