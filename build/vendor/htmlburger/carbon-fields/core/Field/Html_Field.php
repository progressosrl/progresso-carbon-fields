 ...
 */
class Html_Field extends \Progresso\Carbon_Fields\Field\Field
{
    /**
    ...
    public function to_json($load)
    {
        ...
        $field_data = \array_merge($field_data, array('html' => $this->field_html, 'default_value' => $this->field_html));
        return $field_data;
    }
    /**
