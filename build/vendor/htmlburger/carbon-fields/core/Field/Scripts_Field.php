 ...
 */
abstract class Scripts_Field extends \Progresso\Carbon_Fields\Field\Textarea_Field
{
    /**
    ...
    {
        $is_valid_datastore = $this->get_datastore() instanceof \Progresso\Carbon_Fields\Datastore\Theme_Options_Datastore || $this->get_datastore() instanceof \Progresso\Carbon_Fields\Datastore\Network_Datastore;
