...
class Revisions_Service extends \Progresso\Carbon_Fields\Service\Service
{
    const CHANGE_KEY = 'progresso_carbon_fields_changed';
    protected function enabled()
    {
        add_filter('carbon_get_post_meta_post_id', array($this, 'update_post_id_on_preview'), 10, 3);
        add_action('progresso_carbon_fields_post_meta_container_saved', array($this, 'maybe_copy_meta_to_revision'), 10, 2);
    ...
    protected function disabled()
    {
        ...
        remove_action('progresso_carbon_fields_post_meta_container_saved', array($this, 'maybe_copy_meta_to_revision'), 10);
    ...
    public function add_fields_to_revision($fields, $post = null)
    {
        ...
        if (!\function_exists('Progresso\\get_current_screen')) {
            return $fields;
        }
