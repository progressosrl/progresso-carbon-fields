 ...
 */
class Meta_Query_Service extends \Progresso\Carbon_Fields\Service\Service
{
    /**
    ...
    protected function filter_meta_query_array($condition, $container_type)
    {
        ...
        $property = isset($condition['carbon_field_property']) ? $condition['carbon_field_property'] : \Progresso\Carbon_Fields\Value_Set\Value_Set::VALUE_PROPERTY;
