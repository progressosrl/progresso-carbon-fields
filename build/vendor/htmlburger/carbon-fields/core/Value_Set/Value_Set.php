...
namespace Progresso\Carbon_Fields\Value_Set;
...
class Value_Set
{
    ...
    public function __construct($type = self::TYPE_SINGLE_VALUE, $additional_properties = array())
    {
        if (!\in_array($type, $this->valid_types)) {
            \Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise("Invalid type specified for Value_Set: {$type}");
        }
        $this->type = $type;
