...
namespace Progresso\Carbon_Fields\Event;
...
class Emitter
{
    ...
    {
        $listener = \Progresso\Carbon_Fields\Carbon_Fields::resolve('event_persistent_listener');
    ...
    {
        $listener = \Progresso\Carbon_Fields\Carbon_Fields::resolve('event_single_event_listener');
        $listener->set_callable($callable);
        return $this->add_listener($event, $listener);
    }
}
