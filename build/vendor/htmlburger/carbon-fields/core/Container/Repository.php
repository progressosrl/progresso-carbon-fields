...
class Repository
{
     ...
     * @var string
     */
    protected $container_id_prefix = 'progresso_carbon_fields_container_';
    /**
     * Container id prefix
     *
     * @var string
     ...
     */
    public function register_container(\Progresso\Carbon_Fields\Container\Container $container)
    {
