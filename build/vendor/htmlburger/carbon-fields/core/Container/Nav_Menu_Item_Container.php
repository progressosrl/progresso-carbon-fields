 ...
 */
class Nav_Menu_Item_Container extends \Progresso\Carbon_Fields\Container\Container
{
    /**
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Progresso\Carbon_Fields\Datastore\Datastore::make('nav_menu_item'), $this->has_default_datastore());
        }
    ...
    public function init($menu_item_id = 0)
    {
        ...
        if ($this->menu_item_id === 0) {
            ...
            add_action('progresso_carbon_fields_print_nav_menu_item_container_fields', array($this, 'form'), 10, 5);
        }
        return $this;
    }
    /**
    ...
    public function save($data = null)
    {
        ...
        do_action('progresso_carbon_fields_nav_menu_item_container_saved', $this);
    }
    /**
     * {@inheritDoc}
     */
    ...
    {
        include \Progresso\Carbon_Fields\DIR . '/templates/Container/nav_menu_item.php';
    }
    /**
    ...
    protected function get_clone_for_menu_item($menu_item_id, $load = \true)
    {
        if (!isset($this->menu_item_instances[$menu_item_id])) {
            $menu_item_datastore = \Progresso\Carbon_Fields\Datastore\Datastore::make('nav_menu_item');
            ...
            $container = \Progresso\Carbon_Fields\Container\Container::factory($this->type, $menu_item_field_prefix . $this->get_id())->set_datastore($menu_item_datastore, \true)->add_fields($custom_fields)->init($menu_item_id);
            if ($load) {
                $container->load();
            }
    ...
    {
        return 'Progresso\\Carbon_Fields\\Walker\\Nav_Menu_Item_Edit_Walker';
    }
}
