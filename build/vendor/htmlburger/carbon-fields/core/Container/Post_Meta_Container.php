 ...
 */
class Post_Meta_Container extends \Progresso\Carbon_Fields\Container\Container
{
    /**
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Progresso\Carbon_Fields\Datastore\Datastore::make('post_meta'), $this->has_default_datastore());
        }
    }
    /**
    ...
    public function save($post_id = null)
    {
        ...
        do_action('progresso_carbon_fields_post_meta_container_saved', $post_id, $this);
    }
    /**
    ...
    {
        include \Progresso\Carbon_Fields\DIR . '/templates/Container/post_meta.php';
    }
    /**
     ...
     * @param string $context ('normal', 'advanced', 'side' or the custom `progresso_carbon_fields_after_title`)
     */
