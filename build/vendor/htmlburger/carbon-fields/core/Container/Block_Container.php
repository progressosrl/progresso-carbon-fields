...
class Block_Container extends \Progresso\Carbon_Fields\Container\Container
{
    /**
     * {@inheritDoc}
     */
    public $settings = array('preview' => \true, 'parent' => null, 'inner_blocks' => array('enabled' => \false, 'position' => 'above', 'template' => null, 'template_lock' => null, 'allowed_blocks' => null), 'category' => array('slug' => 'common'));
    /***
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Progresso\Carbon_Fields\Datastore\Datastore::make('empty'), $this->has_default_datastore());
        }
    }
    /**
     * {@inheritDoc}
    ...
    {
        return \function_exists('Progresso\\register_block_type');
    }
    /**
     * {@inheritDoc}
     */
    ...
    public function set_category($slug, $title = null, $icon = null)
    {
        ...
        $this->settings['category']['title'] = $title ?: \Progresso\Carbon_Fields\Helper\Helper::normalize_label($slug);
        return $this;
    }
    /**
