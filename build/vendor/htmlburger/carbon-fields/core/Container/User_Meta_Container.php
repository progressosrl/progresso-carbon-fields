...
class User_Meta_Container extends \Progresso\Carbon_Fields\Container\Container
{
    protected $user_id;
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Progresso\Carbon_Fields\Datastore\Datastore::make('user_meta'), $this->has_default_datastore());
        }
    ...
    public function save($user_id = null)
    {
        ...
        do_action('progresso_carbon_fields_user_meta_container_saved', $user_id, $this);
    }
    /**
    ...
    public function render($user_profile = null)
    {
        ...
        include \Progresso\Carbon_Fields\DIR . '/templates/Container/user_meta.php';
    }
    /**
