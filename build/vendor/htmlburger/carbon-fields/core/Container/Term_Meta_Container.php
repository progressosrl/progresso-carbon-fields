 ...
 */
class Term_Meta_Container extends \Progresso\Carbon_Fields\Container\Container
{
    protected $term_id;
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Progresso\Carbon_Fields\Datastore\Datastore::make('term_meta'), $this->has_default_datastore());
        }
    }
    /**
    ...
    public function save($term_id = null)
    {
        ...
        do_action('progresso_carbon_fields_term_meta_container_saved', $term_id, $this);
    }
    /**
    ...
    public function render($term = null)
    {
        ...
        include \Progresso\Carbon_Fields\DIR . '/templates/Container/term_meta.php';
    }
    /**
