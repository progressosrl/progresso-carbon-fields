...
class Array_Translator extends \Progresso\Carbon_Fields\Container\Fulfillable\Translator\Translator
{
    /**
     ...
     */
    public function __construct(\Progresso\Carbon_Fields\Container\Condition\Factory $condition_factory)
    {
     ...
     * {@inheritDoc}
     */
    protected function condition_to_foreign(\Progresso\Carbon_Fields\Container\Condition\Condition $condition)
    {
     ...
     * {@inheritDoc}
     */
    protected function fulfillable_collection_to_foreign(\Progresso\Carbon_Fields\Container\Fulfillable\Fulfillable_Collection $fulfillable_collection)
    {
    ...
    {
        if (!\is_array($foreign)) {
            \Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('Invalid data passed to array condition translator: ' . \print_r($foreign, \true));
            return null;
        }
    ...
    protected function foreign_to_native_fulfillable_collection($foreign)
    {
        ...
        $collection = \Progresso\Carbon_Fields\Carbon_Fields::resolve('container_condition_fulfillable_collection');
