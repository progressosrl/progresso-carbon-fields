...
use Progresso\Carbon_Fields\Datastore\Meta_Datastore;
use Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception;
/**
 * Comment meta container class.
 */
class Comment_Meta_Container extends \Progresso\Carbon_Fields\Container\Container
{
    ...
    public function __construct($id, $title, $type, $condition_collection, $condition_translator)
    {
        ...
        if (!$this->get_datastore()) {
            $this->set_datastore(\Progresso\Carbon_Fields\Datastore\Datastore::make('comment_meta'), $this->has_default_datastore());
        }
    }
    /**
    ...
    {
        include \Progresso\Carbon_Fields\DIR . '/templates/Container/comment_meta.php';
    }
    /**
