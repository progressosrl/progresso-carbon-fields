 ...
 */
abstract class Condition implements \Progresso\Carbon_Fields\Container\Fulfillable\Fulfillable
{
    /**
    ...
    protected function compare($a, $comparison_operator, $b)
    {
        ...
        \Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('Unsupported container condition comparison operator used: ' . $comparison_operator);
        return \false;
    }
    /**
