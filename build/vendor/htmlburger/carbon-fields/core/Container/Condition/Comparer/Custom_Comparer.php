...
class Custom_Comparer extends \Progresso\Carbon_Fields\Container\Condition\Comparer\Comparer
{
    /**
    ...
    {
        if (!\is_callable($b)) {
            \Progresso\Carbon_Fields\Exception\Incorrect_Syntax_Exception::raise('Supplied comparison value is not a callable: ' . \print_r($b, \true));
            return \false;
        }
