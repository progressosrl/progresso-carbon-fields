...
namespace Progresso\Carbon_Fields\Walker;
 ...
 */
class Nav_Menu_Item_Edit_Walker extends \Progresso\Walker_Nav_Menu_Edit
{
    /**
    ...
    public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
    {
        ...
        // Generates the HTML
        \ob_start();
        do_action('progresso_carbon_fields_print_nav_menu_item_container_fields', $item, $output, $depth, $args, $id);
        echo $flag;
        $fields = \ob_get_clean();
