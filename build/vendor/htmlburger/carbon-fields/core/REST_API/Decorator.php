...
class Decorator
{
        ...
        foreach ($containers as $container) {
            ...
            foreach ($fields as $field) {
                ...
                $getter = function ($object, $field_name) use($container) {
                    ...
                    return \Progresso\Carbon_Fields\Helper\Helper::get_value($object_id, $container->type, '', $field_name);
                };
                $setter = function ($value, $object, $field_name) use($container) {
                    $object_id = self::get_object_id($object, $container->type);
                    \Progresso\Carbon_Fields\Helper\Helper::set_value($object_id, $container->type, '', $field_name, $value);
                };
    ...
    public static function get_object_id($object, $container_type)
    {
        ...
        $container_type = \Progresso\Carbon_Fields\Helper\Helper::normalize_type($container_type);
