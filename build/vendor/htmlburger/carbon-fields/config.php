...
if (!\defined(__NAMESPACE__ . '\\URL')) {
    \define(__NAMESPACE__ . '\\URL', \Progresso\Carbon_Fields\Carbon_Fields::directory_to_url(\Progresso\Carbon_Fields\DIR));
}
...
if (!\defined(__NAMESPACE__ . '\\COMPACT_INPUT_KEY')) {
    \define(__NAMESPACE__ . '\\COMPACT_INPUT_KEY', 'progresso_carbon_fields_compact_input');
}
